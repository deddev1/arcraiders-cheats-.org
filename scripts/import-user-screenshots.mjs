...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-arc-raidershacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'arc-raiders-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'arc-raiders-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'arc-raiders-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'arc-raiders-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'arc-raiders-esp-radar.webp',
	},
	{
		source:
		...
		file: 'arc-raiders-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'arc-raiders-battle-royale-combat',
	'arc-raiders-extract-fight',
	'arc-raiders-cheats-aimbot',
	'arc-raiders-cheats-cover',
	'arc-raiders-cheats-esp-wallhack',
	'arc-raiders-cheats-hero',
	'arc-raiders-cheats-logo',
	'arc-raiders-cheats-package',
	'arc-raiders-header-art',
	'arc-raiders-loadout-builder',
	'arc-raiders-player-esp',
	'arc-raiders-scav-run-combat',
	'arc-raiders-scav-run-mode',
	'arc-raiders-squad-fight',
	'arc-raiders-verdansk-map',
];

async function removeOldArc RaidersImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'arc-raiders-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `arc-raiders-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'arc-raiders-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'arc-raiders-cheats-logo.png');
...
await removeOldArc RaidersImages();
