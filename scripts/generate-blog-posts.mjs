#!/usr/bin/env node
/**
 * Generates src/data/blog/posts.generated.ts — NLP-first Arc Raiders Intel posts.
...
const sources = [
	{
		...
		metaDescription:
			'Learn how ARC Raiders patch notes change Raider loadouts, ammo economy, and maps. What to do after Easy Anti-Cheat and season updates in 2026.',
		h1: 'How to Read ARC Raiders Patch Notes Without Guessing',
		intro:
			'When Embark Studios drops a patch, most players skim the headline and queue anyway. That is how you walk into Speranza with the wrong ammo and a gun that just lost its armor pen. Here is a calmer way to read ARC Raiders patch notes so your next raid still makes sense.',
		keywords: [
	...
	},
	{
		...
		metaDescription:
			'A practical ARC Raiders weapon tier list for Raider and extraction raids — ARs, SMGs, bolt-actions, ammo, and when each gun actually wins fights.',
		h1: 'Arc Raiders Weapon Tier List: What Wins Raids in 2026',
		intro:
			'Creator tier lists love flashy guns. ARC Raiders rewards expected value: armor penetration, recoil you can control, and a kit you can rebuild after you die. Here is how to rank weapons for real raids — not highlight reels.',
		keywords: [
			'arc-raiders weapon tier list',
			'best arc-raiders guns',
			'arc-raiders meta weapons',
			'm4a1 arc-raiders',
			'arc-raiders intel',
		],
	...
	},
	{
		...
		metaDescription:
			'Five aggressive but smart ARC Raiders extraction strategies — timings, extracts, third-parties, and how to leave raids with gear instead of empty pockets.',
	...
	},
	{
		...
		metaDescription:
			'What strong ARC Raiders competitors optimize — spawn plans, loadouts, mid-raid habits, and which tournament habits help normal Raider queues.',
		h1: 'What Competitive Arc Raiders Players Optimize For',
		intro:
			'Tournament winners and high-level duos are not lucky spawn gods. They optimize expected value: safer loot paths, cleaner mid-raid habits, and fights they choose on purpose. Here is what translates into your normal ARC Raiders queues.',
		keywords: [
		...
		sections: [
			{
				...
				paragraphs: [
					`Start with schedules and film from ${EXT.game} community events or trusted creators, then tag habits instead of memorizing a single POI name. Note the landing plan, first heal, first rotate, first voluntary fight, and the key late-raid decision.`,
	...
	},
	{
		...
		metaDescription:
			'High-percentage ARC Raiders loot routes for Speranza, Rust Belt, and underground zones — how to leave spawn with guns, armor, and meds that win mid-raid fights.',
	...
	},
	{
		...
		metaDescription:
			'Practical ARC Raiders settings used by strong players — visibility, audio cues, sensitivity, and what to copy vs ignore from pro configs.',
		h1: 'Arc Raiders Settings Guide: See More, Panic Less',
		intro:
			'Copying a champion’s entire config will not make you one. But a few ARC Raiders settings reliably improve visibility, audio reads, and aim consistency. Here is what is worth stealing.',
		keywords: [
			'arc-raiders settings',
			'arc-raiders sensitivity',
			'arc-raiders visibility',
			'arc-raiders audio settings',
			'arc-raiders intel',
		],
	...
	},
	{
		...
		metaDescription:
			'A short ARC Raiders warmup routine before surface raids — aim, peeks, audio focus, and what to practice offline so your first fight is not your warmup.',
		h1: 'Arc Raiders Warmup Routine Before You Queue Raider',
		intro:
			'Queuing cold into industrial zones or underground zones is how you donate a kit. A short ARC Raiders warmup — even ten to fifteen minutes — makes your first real fight feel like your third.',
		keywords: [
			'arc-raiders warmup',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`After a ${EXT.eac} or client update, wait for our rebuild note before queueing. Confirm Embark Studios services on ${EXT.status} if the launcher itself is failing.`,
				],
			},
		],
	},
	{
		...
		metaDescription:
			'A clear 2026 guide to arc raiders cheats — what ESP, soft aim, and radar actually do in ARC Raiders, how Easy Anti-Cheat maintenance works, and how to buy safely.',
		h1: 'Arc Raiders Cheats in 2026: What They Are and How to Use Them Carefully',
		intro:
			'People search “arc raiders cheats” for a simple reason: ARC Raiders is information-heavy, punishing, and full of extract campers. This guide explains what modern undetected packages actually include, how Easy Anti-Cheat maintenance works, and how to decide whether a tool fits your play style.',
		keywords: [
			'arc raiders cheats',
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`Read ${EXT.eac} for how anti-cheat updates ship, then cross-check our <a href="/eac-bypass/">Easy Anti-Cheat maintenance guide</a>. If a shop only answers in private Discord and never writes public notes, assume you will miss patch windows.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'How to tune arc-raiders aimbot and soft aim settings — FOV, smoothness, bone priority, and per-weapon profiles that feel natural in ARC Raiders raids.',
		h1: 'Arc Raiders Aimbot Settings That Feel Natural',
		intro:
			'A harsh aimbot gets you killed by reports and by your own bad habits. Soft, tunable aim assistance is what most ARC Raiders players actually want. Here is how to think about FOV, smoothness, and weapon profiles.',
		keywords: [
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Weapon balance shifts via ${EXT.game}. After ${EXT.eac} patches, confirm <a href="/updates/">Updates</a> before you tune anything on an old build.`,
				],
			},
		],
	},
	{
		...
		metaDescription:
			'What arc-raiders ESP and wallhack actually show in ARC Raiders — players, loot, distance, extracts — and how to keep overlays readable in raids.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					`ESP modules rebuild after ${EXT.eac} patches like everything else. Check <a href="/updates/">Updates</a> and the <a href="/undetected-arc-raiders-cheats/">undetected guide</a>. Season and map changes are announced on ${EXT.game}.`,
	...
	},
	{
		...
		metaDescription:
			'What “undetected arc raiders cheats” really means under Easy Anti-Cheat — maintenance, patch days, risk, and how to read status before you queue ARC Raiders.',
		h1: 'Undetected Arc Raiders Cheats: What Easy Anti-Cheat Reality Looks Like',
		intro:
			'“Undetected” is the most abused word in cheat marketing. Under Easy Anti-Cheat, it means a package is being maintained against current detections — not that bans are impossible. Here is the honest version for ARC Raiders players.',
		keywords: [
			'undetected arc raiders cheats',
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`Arc Raiders Cheats focuses on a full raid stack — player ESP, loot filters, radar, soft aim profiles — with a public <a href="/updates/">Updates</a> page. See <a href="/features/">Features</a> for the list and ${EXT.eac} for anti-cheat context.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'A two-week test of another ARC Raiders cheat before switching to Arc Raiders Cheats — ESP feel, soft aim, patch downtime, and support differences.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Arc Raiders Cheats won me over with written notes on <a href="/updates/">Updates</a>. I still cross-check ${EXT.status} and ${EXT.eac} before queueing blind after patches on any tool.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'Full-stack Arc Raiders Cheats versus minimal ESP-only ARC Raiders tools — feature depth, radar, soft aim, pricing, and who should buy which style.',
		h1: 'Full-Stack Arc Raiders Cheats vs Minimal ESP-Only Tools',
		intro:
			'Some ARC Raiders tools sell a slim ESP module and call it a day. Arc Raiders Cheats ships the wider raid stack. Neither philosophy is automatically wrong — they fit different players. Here is a clear comparison.',
		keywords: [
			'arc-raiders esp only cheat',
			'arc raiders cheats features',
			'radar vs esp',
			'arc-raiders cheat pricing',
			'arc raiders cheats',
		],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Arc Raiders Cheats documents maintenance on <a href="/eac-bypass/">Easy Anti-Cheat workflow</a> and <a href="/undetected-arc-raiders-cheats/">undetected notes</a>. Official game updates ship through ${EXT.game}; anti-cheat background lives on ${EXT.eac}.`,
				],
			},
			{
