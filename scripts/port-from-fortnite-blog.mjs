#!/usr/bin/env node
/**
 * Ports the 8 posts from ../arc-raiders-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'arc-raiders-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'arc-raiders intel'],
...
const file = `/* Auto-generated by scripts/port-from-arc-raiders-blog.mjs — do not edit by hand. */
