...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/arc-raiders-cheats-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/arc-raiders-cheats-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/arc-raiders-cheats-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/arc-raiders-hero-banner.webp');
