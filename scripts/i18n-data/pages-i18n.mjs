...
const PAGE_META_HOME = {
	...
	nl: { title: 'Arc Raiders Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Arc Raiders cheats voor ARC Raiders op PC. ESP wallhack, radar hack en Aimbot met Easy Anti-Cheat-onderhoud. Directe digitale levering.', h1: 'Arc Raiders Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC pakket voor ARC Raiders: ESP wallhack, radar en Aimbot met Easy Anti-Cheat-onderhoud na elke patch.', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'Arc Raiders Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Arc Raiders Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in BR en scav-run.', topicB: 'Eén licentie in plaats van losse tools.' },
	...
	tr: { title: 'Arc Raiders Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'ARC Raiders için undetected hileler. ESP wallhack, radar hack ve Aimbot — Easy Anti-Cheat bakımı. Anında dijital teslimat.', h1: 'Arc Raiders Cheats — Undetected ESP, Wallhack ve Aimbot', intro: 'ARC Raiders Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — Easy Anti-Cheat bakımı dahil.', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'Arc Raiders Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Arc Raiders Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'BR ve scav-run\'da düşman squad okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Arc Raiders Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش ARC Raiders undetected لـ ARC Raiders على PC. ESP wallhack ورadar hack وAimbot مع صيانة Easy Anti-Cheat. تسليم رقمي فوري.', h1: 'Arc Raiders Cheats — ESP وWallhack وAimbot غير مكتشف', intro: 'حزمة undetected لـ ARC Raiders على Windows PC: ESP wallhack ورadar وAimbot مع صيانة Easy Anti-Cheat.', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'معرض Arc Raiders Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Arc Raiders Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وscav-run.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Arc Raiders Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'ARC Raiders向けundetectedチート。ESP wallhack、radar hack、Aimbot、Easy Anti-Cheatメンテナンス。即時デジタル配信。', h1: 'Arc Raiders Cheats — Undetected ESP・Wallhack・Aimbot', intro: 'ARC Raiders Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、Easy Anti-Cheatメンテナンス付き。', imageAlt: 'Arc Raiders cheats hero ESP aimbot wallhack', gallery: 'Arc Raiders Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にArc Raiders Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとscav-runで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	...
	zh: { title: 'Arc Raiders Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'ARC Raiders undetected作弊。ESP wallhack、radar hack、Aimbot、Easy Anti-Cheat维护。即时数字交付。', h1: 'Arc Raiders Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'ARC Raiders Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含Easy Anti-Cheat维护。', imageAlt: 'Arc Raiders cheats hero ESP aimbot wallhack', gallery: 'Arc Raiders Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Arc Raiders Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和scav-run中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	...
	id: { title: 'Arc Raiders Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat ARC Raiders undetected untuk ARC Raiders di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan Easy Anti-Cheat. Pengiriman digital instan.', h1: 'Arc Raiders Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Paket undetected ARC Raiders di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan Easy Anti-Cheat.', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'Galeri Arc Raiders Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Arc Raiders Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di BR dan scav-run.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	th: { title: 'Arc Raiders Cheats 2026 | ESP, Wallhack และ Aimbot', desc: 'Cheat ARC Raiders undetected สำหรับ ARC Raiders บน PC. ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat maintenance. จัดส่งดิจิทัลทันที.', h1: 'Arc Raiders Cheats — Undetected ESP, Wallhack และ Aimbot', intro: 'แพ็ก undetected สำหรับ ARC Raiders บน Windows PC: ESP wallhack, radar, Aimbot พร้อม Easy Anti-Cheat maintenance', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'แกลเลอรี Arc Raiders Cheats — ESP, Aimbot, wallhack', cta2: 'ดูฟีเจอร์', h2a: 'ทำไมเลือก Arc Raiders Cheats ปี 2026', h2b: 'ESP wallhack, radar, Aimbot ในใบอนุญาตเดียว', topicA: 'เหมาะสำหรับอ่าน squad ศัตรูใน BR และ scav-run', topicB: 'ใบอนุญาตเดียวแทนเครื่องมือแยก' },
	vi: { title: 'Arc Raiders Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat ARC Raiders undetected cho ARC Raiders trên PC. ESP wallhack, radar hack, Aimbot, bảo trì Easy Anti-Cheat. Giao hàng kỹ thuật số tức thì.', h1: 'Arc Raiders Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Gói undetected ARC Raiders trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì Easy Anti-Cheat.', imageAlt: 'Arc Raiders ESP player tags hack', gallery: 'Thư viện Arc Raiders Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Arc Raiders Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong BR và scav-run.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
