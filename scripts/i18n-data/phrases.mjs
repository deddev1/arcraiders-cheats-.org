...
const KW = {
	...
	cheats: 'arc raiders cheats',
	hack: 'arc-raiders cheat',
	esp: 'arc-raiders esp',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'arc-raiders aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Arc Raiders Cheats', undetected: 'indetectables', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'Contacta support@arcraiderscheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Arc Raiders Cheats', undetected: 'indétectables', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'Contactez support@arcraiderscheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Arc Raiders Cheats kaufen', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Arc Raiders Cheats', undetected: 'indetectáveis', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'Contacte support@arcraiderscheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Arc Raiders Cheats', undetected: 'indetectable', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'Contatta support@arcraiderscheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'Arc Raiders Cheats kopen', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Arc Raiders Cheats satın al', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'Destek ve yasal sorular için support@arcraiderscheats.org.',
	},
	ar: {
		buy: 'اشترِ Arc Raiders Cheats', undetected: 'غير مكتشف', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Arc Raiders Cheatsを購入', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'サポート・法務: support@arcraiderscheats.org',
	},
	ko: {
		buy: 'Arc Raiders Cheats 구매', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => '지원 및 법무: support@arcraiderscheats.org',
	},
	zh: {
		buy: '购买 Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => '支持与法务：support@arcraiderscheats.org',
	},
	hi: {
		buy: 'Arc Raiders Cheats खरीदें', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'सहायता: support@arcraiderscheats.org',
	},
	id: {
		buy: 'Beli Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Arc Raiders Cheats', undetected: 'undetected', maps: 'Speranza surface zones and extraction routes',
		...
		legal: () => 'support@arcraiderscheats.org för support och juridik.',
	},
};
