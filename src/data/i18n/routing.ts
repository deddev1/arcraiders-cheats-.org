...
export const localizedSlugs: Record<PageId, Record<LocaleCode, string>> = {
	...
	features: {
		...
		de: 'arc-raiders-cheats-funktionen',
		pt: 'recursos-cheats-arc-raiders',
		it: 'funzioni-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-functies',
		pl: 'funkcje-cheatow-arc-raiders',
		ru: 'funkcii-chitov-arc-raiders',
		tr: 'arc-raiders-hile-ozellikleri',
		ar: 'arc-raiders-cheats-features',
		ja: 'arc-raiders-cheats-features',
		ko: 'arc-raiders-cheats-features',
		zh: 'arc-raiders-cheats-features',
		hi: 'arc-raiders-cheats-features',
		id: 'arc-raiders-cheats-features',
		th: 'arc-raiders-cheats-features',
		vi: 'arc-raiders-cheats-features',
		uk: 'funkcii-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-funkce',
		ro: 'functii-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-funktioner',
	},
	pricing: {
		en: 'pricing',
		es: 'precios-trucos-arc-raiders',
		fr: 'prix-triche-arc-raiders',
		de: 'arc-raiders-cheats-preise',
		pt: 'precos-cheats-arc-raiders',
		it: 'prezzi-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-prijzen',
		pl: 'ceny-cheatow-arc-raiders',
		ru: 'ceny-chitov-arc-raiders',
		tr: 'arc-raiders-hile-fiyatlari',
		ar: 'arc-raiders-cheats-pricing',
		ja: 'arc-raiders-cheats-pricing',
		ko: 'arc-raiders-cheats-pricing',
		zh: 'arc-raiders-cheats-pricing',
		hi: 'arc-raiders-cheats-pricing',
		id: 'arc-raiders-cheats-pricing',
		th: 'arc-raiders-cheats-pricing',
		vi: 'arc-raiders-cheats-pricing',
		uk: 'ciny-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-ceny',
		ro: 'preturi-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-priser',
	},
	setup: {
		en: 'setup',
		es: 'instalacion-trucos-arc-raiders',
		fr: 'installation-triche-arc-raiders',
		de: 'arc-raiders-cheats-installation',
		pt: 'instalacao-cheats-arc-raiders',
		it: 'installazione-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-installatie',
		pl: 'instalacja-cheatow-arc-raiders',
		ru: 'ustanovka-chitov-arc-raiders',
		tr: 'arc-raiders-hile-kurulum',
		ar: 'arc-raiders-cheats-setup',
		ja: 'arc-raiders-cheats-setup',
		ko: 'arc-raiders-cheats-setup',
		zh: 'arc-raiders-cheats-setup',
		hi: 'arc-raiders-cheats-setup',
		id: 'arc-raiders-cheats-setup',
		th: 'arc-raiders-cheats-setup',
		vi: 'arc-raiders-cheats-setup',
		uk: 'vstanovka-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-instalace',
		ro: 'instalare-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-installation',
	},
	updates: {
		en: 'updates',
		es: 'actualizaciones-trucos-arc-raiders',
		fr: 'mises-a-jour-triche-arc-raiders',
		de: 'arc-raiders-cheats-updates',
		pt: 'atualizacoes-cheats-arc-raiders',
		it: 'aggiornamenti-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-updates',
		pl: 'aktualizacje-cheatow-arc-raiders',
		ru: 'obnovleniya-chitov-arc-raiders',
		tr: 'arc-raiders-hile-guncellemeleri',
		ar: 'arc-raiders-cheats-updates',
		ja: 'arc-raiders-cheats-updates',
		ko: 'arc-raiders-cheats-updates',
		zh: 'arc-raiders-cheats-updates',
		hi: 'arc-raiders-cheats-updates',
		id: 'arc-raiders-cheats-updates',
		th: 'arc-raiders-cheats-updates',
		vi: 'arc-raiders-cheats-updates',
		uk: 'onovlennya-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-aktualizace',
		ro: 'actualizari-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-uppdateringar',
	},
	faq: {
		en: 'faq',
		es: 'preguntas-trucos-arc-raiders',
		fr: 'faq-triche-arc-raiders',
		de: 'arc-raiders-cheats-faq',
		pt: 'faq-cheats-arc-raiders',
		it: 'faq-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-faq',
		pl: 'faq-cheatow-arc-raiders',
		ru: 'faq-chitov-arc-raiders',
		tr: 'arc-raiders-hile-sss',
		ar: 'arc-raiders-cheats-faq',
		ja: 'arc-raiders-cheats-faq',
		ko: 'arc-raiders-cheats-faq',
		zh: 'arc-raiders-cheats-faq',
		hi: 'arc-raiders-cheats-faq',
		id: 'arc-raiders-cheats-faq',
		th: 'arc-raiders-cheats-faq',
		vi: 'arc-raiders-cheats-faq',
		uk: 'faq-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-faq',
		ro: 'faq-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-faq',
	},
	support: {
		en: 'support',
		es: 'soporte-trucos-arc-raiders',
		fr: 'support-triche-arc-raiders',
		de: 'arc-raiders-cheats-support',
		pt: 'suporte-cheats-arc-raiders',
		it: 'supporto-trucchi-arc-raiders',
		nl: 'arc-raiders-cheats-support',
		pl: 'wsparcie-cheatow-arc-raiders',
		ru: 'podderzhka-chitov-arc-raiders',
		tr: 'arc-raiders-hile-destek',
		ar: 'arc-raiders-cheats-support',
		ja: 'arc-raiders-cheats-support',
		ko: 'arc-raiders-cheats-support',
		zh: 'arc-raiders-cheats-support',
		hi: 'arc-raiders-cheats-support',
		id: 'arc-raiders-cheats-support',
		th: 'arc-raiders-cheats-support',
		vi: 'arc-raiders-cheats-support',
		uk: 'pidtrymka-chitiv-arc-raiders',
		cs: 'arc-raiders-cheats-podpora',
		ro: 'suport-cheats-arc-raiders',
		sv: 'arc-raiders-cheats-support',
	},
	undetected: {
		en: 'undetected-arc-raiders-cheats',
		es: 'trucos-arc-raiders-indetectables',
		fr: 'triche-arc-raiders-indetectable',
		de: 'unentdeckte-arc-raiders-cheats',
	...
	'best-cheats': {
		...
		cs: 'nejlepsi-arc-raiders-cheats',
		ro: 'cele-mai-bune-cheats-arc-raiders',
		sv: 'basta-arc-raiders-cheats',
	},
	'aimbot-hack': {
