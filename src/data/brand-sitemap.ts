...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'arc raiders cheats esp',
		caption: 'arc raiders cheats esp wallhack',
	},
	{
		src: '/images/arc-raiders-cheats-wallhack.webp',
		title: 'arc raiders cheats wallhack',
		caption: 'arc raiders cheats wallhack esp',
	},
	{
		src: '/images/arc-raiders-cheats-aimbot.webp',
		title: 'arc raiders cheats aimbot',
		caption: 'arc raiders cheats aimbot soft aim',
	},
	{
		src: '/images/arc-raiders-cheats-aimbot-view.webp',
		title: 'arc raiders cheats aimbot',
		caption: 'arc raiders cheats aimbot view',
	},
	{
		src: '/images/arc-raiders-cheats-radar.webp',
		title: 'arc raiders cheats radar',
		caption: 'arc raiders cheats radar hack',
	},
	{
		src: '/images/arc-raiders-cheats-raid.webp',
		title: 'arc raiders cheats',
		caption: 'arc raiders cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Arc Raiders', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'arc-raiders-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'arc-raiders-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for ARC Raiders on PC' },
