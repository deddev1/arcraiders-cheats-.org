...
export const homeFaqs: readonly FaqItem[] = [
	...
	faq({
		question: 'Does this work in surface raids and extraction runs?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} raid flow — reading Raiders and ARC drones, spotting loot, and staying aware near extracts.',
		slug: 'pmc-raids-and-scav-runs',
		seoTitle: 'PMC Raid and Scav Support | FAQ',
		seoDescription:
			'{brand} works in surface raids and extraction runs — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Arc Raiders Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Arc Raiders Cheats feels smooth on Customs.',
	...
	reviewMeta({
		...
		slug: 'arc-raiders-esp-scav-run-review-buildsr4k',
		seoTitle: 'ESP Review by @buildsR4K — 4/5 | {brand}',
		seoDescription: '@buildsR4K rates {brand} ESP 4/5 for extraction runs on Windows PC.',
		date: '2026-07-19',
		tag: 'extraction run',
	}),
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Arc Raiders Cheats this wipe. Setup was simple. It stayed up after the last Easy Anti-Cheat update when my old cheat failed. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Arc Raiders Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Arc Raiders Cheats pays for the monthly plan. Extract markers and distance make early raids faster.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Arc Raiders Cheats since last wipe. Soft aim per weapon helps in dorms. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Arc Raiders Cheats helps in dorms.',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Arc Raiders Cheats saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Arc Raiders Cheats saved me near extracts.',
		slug: 'arc-raiders-radar-hack-review-vanlifeeft',
	...
	reviewMeta({
		...
		slug: 'arc-raiders-battleye-update-review-patchdaymike',
